...
The default run uses `gamma_step=0.1`, `tv_grid_n=2500`, and `opt_grid_n=251`, matching the thesis-oriented plotting run. For a finer grid used to check grid-level minimizers more precisely, run:

```bash
python run_chapter4.py --gamma-step 0.01 --tv-grid-n 2500 --opt-grid-n 251
```
